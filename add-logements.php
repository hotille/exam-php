...
if (!empty($_POST)) {
    ...
    $request = 'INSERT INTO logements(titre, adresse, ville, cp, surface, prix, photo, type, description)
    ...
    <div class="container">
        <div class="row mt-3">
            <div class="col-12">
                ...
                <form action="add-logements.php" method="post" class="form" enctype="multipart/form-data">
                    ...
                    <input name="surface" placeholder="surface" type="number" class="form-control">
                    <input name="prix" placeholder="prix" type="number" class="form-control">
